...
basedir = "/Users/marionharmand/Documents/0_CNRS/Manip/Manip_2016/LCLS_XPP_May2016/Analysis/dispersiveXanes_FilterEner/"
g_folder_init = basedir + "/" + g_exp + "_init_pars/"
g_folder_out = basedir + "/" + g_exp + "_output/"
# g_folder_data = "/reg/d/psdm/"+g_bml+"/"+ g_exp +"/hdf5/"
g_folder_data = (
    "/Users/marionharmand/Documents/0_CNRS/Manip/Manip_2016/LCLS_XPP_May2016/Data/"
)
# g_folder_data = "/Users/marionharmand/Documents/0_CNRS/Manip/Manip_2016/LCLS_MEC_May2016/Data/HDF5"
...
class AnalyzeRun(object):
    ...
    def loadTransform(self, fname="auto", calib=None):
        ...
        temp = np.load(fname, allow_pickle=True).item()
